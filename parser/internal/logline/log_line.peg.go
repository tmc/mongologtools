...
func (p *logLineParser) Init() {
	...
	_rules = [...]func() bool{
								...
								l323:
									{
										...
										l326:
											depth--
											add(rulestringChar, position325)
										}
										goto l323
									l324:
						...
						case '[':
							{
								...
								}
								{
									...
									l346:
										...
										depth--
										add(ruleListElements, position345)
									}
									goto l344
								l343:
		...
		nil,
		/* 81 Action11 <- <{ p.SetField("command_type", buffer[begin:end]); p.StartField("command") }> */
		nil,
